...
about.page <- modalDialog(fluidPage(HTML(about.wording)),
                          size = 'l')
...
predict.re.page <- function(curr.date) {
  return.page <- modalDialog(
    ...
    dataTableOutput(outputId = 'input_hosp_dt'),
    
    tags$script(
      "$(document).on('click', '#input_hosp_dt button', function () {
